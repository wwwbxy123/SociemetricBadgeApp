...
//      mHandler = new Handler();
        ...
        mValueStore = new ValueStore();                                              // Instantiate the ValueStore Class
        DirectoryAndFile dataFiles = new DirectoryAndFile(this);        // Instantiate the DirectoryAndFile Class
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (data != null) {
                ...
                result.setText("Scan result：" + content);
            }
        }
    }
